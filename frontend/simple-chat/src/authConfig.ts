...
// AUTH DISABLED - Uncomment this function to re-enable fetching auth setup from backend
/*
...
// AUTH DISABLED - Using static defaults instead of fetching from backend
